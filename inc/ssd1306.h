...
extern void ssd1306_draw_char(uint8_t *ssd, int16_t x, int16_t y, uint8_t character, bool inverted);
extern void ssd1306_draw_string(uint8_t *ssd, int16_t x, int16_t y, char *string, bool inverted);
